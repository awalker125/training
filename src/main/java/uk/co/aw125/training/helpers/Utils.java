...
public class Utils {
	...
	/**
	 * Removes special characters matched by regex \W and replaces with another
	 * string
	 *
	 * @param orig
	 *            string to have special chars removed from
	 * @param sub
	 *            string to replace special chars with. If null replaced with ""
	 * @return the original string with the whitespace stripped
	 */
	...
	/**
	 * An implementation of the perl unless statement. This reverses a boolean.
	 * i.e if true this returns false and vice versa
	 *
	 * @param b
	 * @return
	 */
